...
public class ThunderStruckForestFruitDecorator extends CocoaDecorator {
	public static Codec<ThunderStruckForestFruitDecorator> CODEC = Codec.unit(ThunderStruckForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("thunder_struck_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public ThunderStruckForestFruitDecorator() {
		super(0.2f);
	}
